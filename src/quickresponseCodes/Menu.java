...
@Author(name="Tejbir Singh and Arpita Singh",date="2 March 2019")
public class Menu {
    static JFrame frame;
    static JPanel panel;
    ...
    private Menu(){
        ...
        JOptionPane.showMessageDialog(frame,"This is a QR code applet created by Arpita Singh and Tejbir Singh.\nYou can create your own your QR-Code, and can also read them\nAll Images are clickable!");
    }
